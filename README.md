>>При запуске порграмма просит ввести ключевое слово поиска вакансий.
> После удачного соединения выводит количество найденных вакансий и предлагает воспользоваться сортировкой и фильтрацией:
> * sort - сортировка по ЗП "ДО".
...
>> Результат сохранения можно увидеть в отдельном файле result.json в папке (src/parsed_data/).
